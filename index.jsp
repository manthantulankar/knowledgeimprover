...
<title>Fast information improver</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Fast information improver</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#">Profile</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#">About</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#">Contact</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To fast information improver</h1>
			<!-- Icon Divider-->
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			<!-- Section Heading-->
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">your choice</h2>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Fast Knowledge Improver is a web-based environment that allows Searching of College 
					related to your future. This is the smart way to get information about college. You can also search for Scholarship
					 & Entrance Exam.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead"> It will also provide you the detail information related 
					to the Scholarship, entrance Exam and Syllabus of Exam related to your 
					field in which you are going to make your carrier.</p>
				</div>
			</div>
		</div>
	</section>
